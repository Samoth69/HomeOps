...
module.exports = {
    ...
    sonarr: [
        `https://sonarr-anime.${process.env.SECRET_DOMAIN}/?apikey=${process.env.SONARR_ANIME__AUTH__APIKEY}`,
        `https://sonarr-tv.${process.env.SECRET_DOMAIN}/?apikey=${process.env.SONARR_TV__AUTH__APIKEY}`
    ],
